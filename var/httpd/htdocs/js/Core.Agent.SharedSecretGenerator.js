...
Core.Agent.SharedSecretGenerator = (function (TargetNS) {
    ...
    TargetNS.Init = function () {
        ...
        $("#UserGoogleAuthenticatorSecretKey + button").on("click", function(){
			...
			var url = "otpauth://totp/Agent?secret="+sharedSecret+"&issuer=OTRS 6 (CE)";
			
			// Generate and Output QR Code
			$('#qrcode').html("<h4 align=\"center\">1. Open Your Authentication App and Scan the QR Code Below. <br>2. Click 'Save Setting' On Your Right.</h4><br/>");
